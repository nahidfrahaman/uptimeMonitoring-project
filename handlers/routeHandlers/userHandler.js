...
handler._user.post = (requestProperty, callback) => {
    ...
    const toAgrement= typeof requestProperty.body.toAgrement=== 'boolean' && requestProperty.body.firstName.trim().length > 0 ? requestProperty.body.toAgrement: false ;
    console.log(firstName, lastName,phone, password, toAgrement);
...
handler._user.put = (requestProperty, callback) => {
    ...
    if(phone) {
       ...
       if(firstName || lastName || password) {
        ...
        callback(404, {
            errorMessage : 'requested user was not found hohoho '
        })
    }
